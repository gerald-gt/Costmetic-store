<!--Footer Part Start-->
	<footer id="footerWrapper" class="clear">
        	...
        	<div class="column">
          	...
          	<div class="column">
				...
				<ul>
              		...
              		<li><img src="image/phone.png" width="14px" height="14px"> 5 495 4491</li>
              		<li><a href="#" onmouseover="showAddress();" onmouseout="hideAddress();">Address</a></li>
				</ul>
				<div id="AddressDiv" class="AddressDiv">
					<p><b>Sanc Souci Road</b></p>
					<p><b>Montagne Blanche</b></p>
				</div>
          	</div>
          	<div class="column">
            	<h3>Extras</h3>
        ...
        <div class="powered-main">
        	<div id="powered"> Designed By <a href=mailto:"nadeem.it@live.com">S.Gerald Nelson</a>
            	<div class="fr">Copyright <a href="default.php">Asia Jewellery</a> Your Online Store &copy; <?php /*$date = date("l, d F, Y");*/echo date("Y") ?></div>
